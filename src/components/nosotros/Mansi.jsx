            ...
            <div className="col-md-4">
                <div className="card card_color">
                    ...
                    <div className="card-body">
                        ...
                        <b>    Le gusta el cine de superheroes y anime, de preferencia</b><br />
                         Calladito y Tranquilo pero tiene varios trucos bajo la manga,
                         un tipo inofensivo pero peligroso, según testigos.
                        <br />
                            <b>Generos Favoritos:</b> Anime, Super Heroes, Accion
                        <br />
                            <hr />
                            ...
                            <li><Link to="/details/tt0988045" target="_blank">Sherlock Holes</Link></li>
                            ...
                            <li><Link to="/details/tt0814243" target="_blank">One Pice</Link></li>
                            <li><Link to="/details/tt0434665" target="_blank">Bleach</Link></li>
                            <li><Link to="/details/tt0412142" target="_blank">House</Link></li>
                            <li><Link to="/details/tt0903747" target="_blank">Braking Bad</Link></li>
